...
AUDIO_LANGUAGE = "zh"               # Source language (e.g., Chinese)
OUTPUT_LANGUAGE = "en"              # Target language (e.g., English)

# Path settings
AUDIO_FOLDER = "audio_sample"        # Path to your audio files
OUTPUT_FOLDER = "output"             # Path for saved transcripts
```
6. Run
